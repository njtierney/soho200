...
- End: 3pm [Preachers Bar](https://www.facebook.com/preachershobart)
...
soho200 <- read_csv("soho-200-data.csv",
...
You get 1 lifelines they are all: Call Nick. However you get as many lifelines as you like if you call Nick from a Telstra phone booth (It’s free, really!)
...
- Make up your own set bonus and award your own points. Must explain at pub.
- Salamanca So Fresh Right now: Visit both Sal Fresh at SoHo and Salamanca Fresh at - Salamanca. 100 points
...
- Ice cream float: complete ice cream run and also have
- Water world: Travel by water (boat, swim, etc!) between two controls and get 10X those - combined points.
- Starfish: Pull a starfish out of the water somewhere in Hobart. 300 points.
- Four Corners: Do controls 9, 30, 35, and 1 - bonus 250 points.
- West Side: Controls 1-4, 20, 32-39 - bonus 100 points
- Knock off knock lofty: do controls 37, 38, and 39.
- Academy Awards: Most controls visited - bonus 250 points
- Echidna bonus: See an Echidna, bonus 250 points.
- Monotreme bonus: See both a live platypus Echidna and Platypus - 2,000 bonus points
- Find and tag Nick betwen 11:30 - 1pm
- Find someone’s birthday and sing happy birthday to them. Can be over the phone/video
- Swifty bonus: See a (live) swift parrot
- Fully Swifty: Monotreme bonus + Swifty bonus: 10X your score.

# Hobart Celebrities to get photos with
- David Walsh (1000 points)
- Bob Brown (500 points)
- Hannah Moloney (250 points)
- Santa Claus (300 points)
- Someone you think is a celebrity? (??? points?)
